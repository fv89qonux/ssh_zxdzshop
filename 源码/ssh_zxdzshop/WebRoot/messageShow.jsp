...
<input name="搜索" type="submit" value="搜索" />
    ...
    <td class="center_content" height=500px align="center">
     <br/><h3>留言板</h3>
  <show:QueryTag user="root" tableName="message" pass="root" dataSource="ssh_zxdzshop"></show:QueryTag>
  <%=queryResult %>
  ...
  <div class="footer" align="center"><br />&copy;&nbsp;2012&nbsp;|&nbsp;黄淮学院&nbsp;|&nbsp;信息工程学院&nbsp;|&nbsp;网上商城系统<br/><a href="admin/login.jsp" target="_blank">后台管理</a></div>
